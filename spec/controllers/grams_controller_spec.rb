...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update action" do
    ...
    it "should't let unauthorized users create a gram" do
      gram = FactoryGirl.create(:gram)
    ...
    it "should render the edit form with an http status of unprocessable_entity for validation errors" do
      gram = FactoryGirl.create(:gram, message: "Initial Value")
      sign_in gram.user
